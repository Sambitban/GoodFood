        ...
        <Stack className="h-[832px] max-w-[1151px] mx-[auto] sm:px-[15px] relative w-[100%]">
          ...
          <Stack className="absolute h-[832px] w-[100%]">
            <Column
              ...
              style={{ backgroundImage: "url('images/img_ellipse15.png')" }}
            >
              <Column className="flex flex-col justify-start sm:mb-[39px] md:mb-[51px] mb-[66px] md:mr-[13px] mr-[17px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[83%]">
                ...
                <Column className="bg-white_A700 flex flex-col items-center justify-start md:mr-[17px] mr-[22px] md:mt-[106px] mt-[138px] sm:mt-[82px] sm:mx-[0] sm:p-[15px] md:p-[29px] p-[38px] rounded-radius30 shadow-bs sm:w-[100%] w-[96%]">
                  <Column className="flex flex-col justify-start md:mb-[10px] mb-[13px] sm:mb-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[91%]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:px-[0] w-[100%]">
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[24%]">
                        <Img
                    ...
                    <Text
                      className="leading-[30.00px] md:leading-[normal] sm:leading-[normal] sm:mt-[4px] md:mt-[6px] mt-[8px] sm:mx-[0] text-gray_901 sm:w-[100%] w-[71%]"
                      as="h2"
                      variant="h2"
                    >
                    ...
                    <Text
                      className="font-normal leading-[22.00px] md:leading-[normal] sm:leading-[normal] ml-[2px] sm:mt-[10px] md:mt-[13px] mt-[17px] sm:mx-[0] not-italic text-gray_901 tracking-ls08 md:tracking-ls1 sm:tracking-ls1 sm:w-[100%] w-[99%]"
                      as="h4"
                      variant="h4"
                    >
                      True love for veg salads brings you to this dish. A tasty
                      mix of veggies & herbs. A healthy treat rich in minerals &
                      Vitamins.
                    </Text>
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[4px] sm:px-[0] w-[100%]">
                      <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                        <Text
                        ...
                        <Text
                          className="mt-[4px] text-light_green_800 md:tracking-ls1 sm:tracking-ls1 tracking-ls12000000000000002 w-[auto]"
                          as="h2"
                          variant="h2"
                        >
                          $125
                    ...
                    <Button
                      className="cursor-pointer font-medium sm:mt-[22px] md:mt-[28px] mt-[37px] text-[20px] text-center tracking-ls1 w-[100%]"
            ...
            <Column className="absolute bottom-[38%] flex flex-col justify-start left-[0] sm:mx-[0] md:p-[11px] p-[15px] sm:px-[0] sm:py-[8px] sm:w-[100%] w-[43%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mb-[1px] md:ml-[30px] ml-[40px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[77%]">
                <Img
            ...
            <Stack className="absolute bottom-[24%] h-[114px] left-[0] sm:w-[100%] w-[43%]">
              <Column className="absolute flex flex-col h-[max-content] inset-y-[0] justify-start sm:mx-[0] my-[auto] sm:px-[0] right-[17%] sm:w-[100%] w-[51%]">
                ...
                <Text
                  ...
                  variant="body1"
                >
                  True love for veg salads brings you to this dish. A tasty mix
                  of veggies & herbs.
                </Text>
              </Column>
