        ...
        <Stack className="h-[832px] max-w-[1151px] mx-[auto] sm:px-[15px] relative w-[100%]">
          ...
          <Stack className="absolute h-[832px] w-[100%]">
            <Column
              ...
              style={{ backgroundImage: "url('images/img_ellipse16.png')" }}
            >
              <Column className="flex flex-col justify-start sm:mb-[39px] md:mb-[51px] mb-[66px] md:mr-[13px] mr-[17px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[83%]">
                ...
                <Column className="bg-white_A700 flex flex-col items-center justify-start md:mr-[17px] mr-[22px] md:mt-[106px] mt-[138px] sm:mt-[82px] sm:mx-[0] sm:p-[15px] md:p-[29px] p-[38px] rounded-radius30 shadow-bs sm:w-[100%] w-[96%]">
                  <Column className="flex flex-col justify-start md:mb-[10px] mb-[13px] sm:mb-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[93%]">
                    ...
                    <Text
                      className="leading-[30.00px] md:leading-[normal] sm:leading-[normal] sm:mt-[4px] md:mt-[6px] mt-[8px] sm:mx-[0] text-gray_901 sm:w-[100%] w-[70%]"
                      as="h2"
                      variant="h2"
                    >
                      Veggies & Fruits Platter
                    </Text>
                    <Text
                      className="font-normal leading-[22.00px] md:leading-[normal] sm:leading-[normal] ml-[2px] sm:mt-[10px] md:mt-[13px] mt-[17px] sm:mx-[0] not-italic text-gray_901 tracking-ls08 md:tracking-ls1 sm:tracking-ls1 sm:w-[100%] w-[98%]"
                      as="h4"
                      variant="h4"
                    >
                      Healthy mix of tropical vegetables with ayurvedic herbs.
                      Unlimited options on fresh tropical fruits and veggies.
                    </Text>
                    ...
                    <Button
                      className="cursor-pointer font-medium min-w-[99%] sm:mt-[22px] md:mt-[28px] mt-[37px] text-[20px] text-center tracking-ls1 w-[max-content]"
            ...
            <Stack className="absolute bottom-[10%] h-[114px] left-[0] sm:w-[100%] w-[43%]">
